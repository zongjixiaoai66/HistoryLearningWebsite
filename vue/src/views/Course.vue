...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:8999/course/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
<!--      <el-table-column prop="md5" label="文件md5"></el-table-column>-->
      ...
      <el-table-column label="操作"  width="350" align="center">
        <template slot-scope="scope">
          <el-button type="primary" @click="lookvideo(scope.row.fileurl)">查看视频</el-button>
    ...
    <el-dialog title="教学视频" :visible.sync="dialogFormVisible1" width="40%" :before-close='outClose'>
      <video
          style="width:100%"
          :src="lookvideourl"
          class="avatar video-avatar"
