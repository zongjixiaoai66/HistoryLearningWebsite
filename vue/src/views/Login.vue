<template>
  <div class="wrapper">
    <div style="height: 60px; line-height: 60px; font-size: 20px; padding-left: 50px; color: white;
      background-color: rgba(0,0,0,0.2)">历史学习网站</div>
    <div style="margin: 150px auto; background-color: #fff; width: 350px; height: 350px; padding: 20px; border-radius: 10px">
      ...
      <el-form :model="user" :rules="rules" ref="userForm">
        <el-form-item prop="type" >
          <el-select v-model="user.type" placeholder="请选择登录角色" size="medium" style="display:block;width: 100%">
            <el-option label="学生" value="ROLE_USER"></el-option>
        ...
        <!--        <el-form-item prop="type" style="margin-left: 100px;" v-model="user.type">-->
        <!--          <el-dropdown>-->
        <!--            <el-button type="warn">-->
        <!--              请选择登录角色<i class="el-icon-arrow-down el-icon&#45;&#45;right"></i>-->
        <!--            </el-button>-->
        <!--            <el-dropdown-menu slot="dropdown">-->
        <!--              <el-dropdown-item value="1" v-model="user.type">学生</el-dropdown-item>-->
        <!--              <el-dropdown-item value="2" v-model="user.type">教师</el-dropdown-item>-->
        <!--              <el-dropdown-item value="3" v-model="user.type">管理员</el-dropdown-item>-->
        <!--            </el-dropdown-menu>-->
        <!--          </el-dropdown>-->
