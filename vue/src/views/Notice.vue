<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="http://localhost:8999/notice/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="content" label="课件名称">
<!--        <template v-slot="scope">-->
<!--          <el-button type="primary" @click="view(scope.row.content)">查看内容</el-button>-->
<!--        </template>-->
      </el-table-column>
      <el-table-column prop="time" label="发布时间"></el-table-column>
<!--      <el-table-column prop="url" label="课件链接"></el-table-column>-->
      ...
      <el-table-column label="操作"  width="300" align="center">
        <template slot-scope="scope">
          <el-button type="success" @click="handleEdit(scope.row)">编辑 <i class="el-icon-edit"></i></el-button>
            <el-button type="primary" @click="download(scope.row.url)">导出</el-button>
<!--          <el-upload action="http://localhost:8999/file/upload" :show-file-list="false"-->
<!--                     :on-success="handleFileUploadSuccess" style="display: inline-block">-->
<!--            <el-button type="primary" class="ml-5">上传课件 <i class="el-icon-top"></i></el-button>-->
<!--          </el-upload>-->
          <el-popconfirm
              class="ml-5"
              confirm-button-text='确定'
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="50%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="课件名称">
          <p v-if="form.content" v-model="form.content"></p>
          <el-upload action="http://localhost:8999/file/uploadKeJian" :show-file-list="false"
                     :on-success="handleFileuploadKeJianSuccess" style="display: inline-block">
            <el-button type="primary" class="ml-5">上传课件 <i class="el-icon-top"></i></el-button>
          </el-upload>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleFileuploadKeJianSuccess(res) {
      this.$message.success("上传课件成功");
      this.form.content = res.data.name
    ...
    exp() {
      window.open("http://localhost:8999/notice/export")
    },
