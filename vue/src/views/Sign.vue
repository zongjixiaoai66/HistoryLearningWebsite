...
<!--      <el-button type="primary" @click="handleAdd">新增 <i class="el-icon-circle-plus-outline"></i></el-button>-->
      ...
      <!-- <el-upload action="http://localhost:8999/sign/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
...
export default {
  ...
  methods: {
    ...
    exp() {
      window.open("http://localhost:8999/sign/export")
    },
